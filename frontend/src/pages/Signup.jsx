      ...
      <div className="w-full max-w-sm">
        ...
        <div className="card">
          ...
          <p className="mb-6 text-sm text-white/50">
            One account per tutor. You&apos;ll use this email and password to log in anytime.
          </p>
          ...
          <form onSubmit={onSubmit} className="space-y-4">
            ...
            <div>
              ...
              />
              <p className="mt-1 text-xs text-white/40">This becomes your login email.</p>
            </div>
            <div>
